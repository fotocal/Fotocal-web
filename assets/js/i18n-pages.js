...
(function () {
  ...
  var PAGES = {
    ...
    en: {
      ...
      "fx.f9.l1": "Calories and macros, day by day",
      "fx.f9.l2": "What held up and what slipped",
      "fx.f9.l3": "One or two things to try next week",
      ...
      "fp.scan-food.recImg": "../../assets/img/screens/coach-chat-en.webp",
      "fp.scan-food.recAlt": "Real app screen: the Coach Kal chat answering a question about the scanned chicken bowl with the numbers from the user's day",
    ...
    es: {
      ...
      "fx.f9.l1": "Calorías y macros, día a día",
      "fx.f9.l2": "Qué aguantó y qué se torció",
      "fx.f9.l3": "Una o dos cosas que probar la semana que viene",
      ...
      "fp.scan-food.recImg": "../../assets/img/screens/coach-chat-es.webp",
      "fp.scan-food.recAlt": "Pantalla real de la app: el chat de Coach Kal responde a una pregunta sobre el bol de pollo escaneado con los números del día del usuario",
