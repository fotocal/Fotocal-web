...
(function () {
  ...
  var PAGES = {
    ...
    en: {
      ...
      "fp.voice-logging.s4Img": "../../assets/img/screens/log-voice-en.webp",
      "fp.voice-logging.s4Alt": "Real app screen: the voice result, three foods recognised from speech, each with its calories and macros, ready to check before saving",
    ...
    es: {
      ...
      "fp.voice-logging.s4Img": "../../assets/img/screens/log-voice-es.webp",
      "fp.voice-logging.s4Alt": "Pantalla real de la app: el resultado por voz, tres alimentos reconocidos al hablar, cada uno con sus calor\u00edas y macros, listo para revisar antes de guardar",
