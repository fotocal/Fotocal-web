...
(function () {
  ...
  var PAGES = {
    ...
    en: {
      ...
      "ai.w2b": "Spanish and English, in the app and on this site. Ask in whichever one you think in and the answer comes back in the same one.",
      ...
      "ai.lim.body": "This is the section the in-app note points at, so it is worth being blunt about it. Coach Kal is an AI language model. It produces estimates and fluent, plausible-sounding answers — and plausible is not the same thing as correct.",
      ...
      "ai.lim.medB2": "If you are pregnant, living with diabetes or another condition, taking medication, recovering from an eating disorder, or making a significant change to how you eat, speak to a doctor or a registered dietitian first. Their advice comes ahead of Kal's — it is not designed to replace them and should not be used as if it could.",
      ...
      "ai.al.1": "If you have entered an allergy, Kal will not recommend a food it identifies as containing it.",
      ...
      "ai.al.warnB": "Kal works from what it can identify, and identification can be wrong. A mislabelled ingredient, an unfamiliar dish or a hidden trace will get past it. If an allergy of yours is serious, the packet and the person who cooked the food are the authority — not an app. Never rely on Coach Kal alone to decide whether something is safe for you to eat.",
      ...
      "ai.imgAlt": "Real app screenshot: the Coach Kal chat. The user asks about a scanned 905-kcal chicken bowl; Kal answers that it would put them 242 kcal over the 663 they have left, notes its 40 g of protein toward a 159 g daily goal, and gives three practical tips",
      "ai.img": "../assets/img/screens/coach-kal-chat-en.webp",
    ...
    es: {
      ...
      "ai.w2b": "Español e inglés, en la app y en esta web. Pregunta en el idioma en el que piensas y la respuesta vuelve en ese mismo.",
      ...
      "ai.lim.body": "Esta es la sección a la que apunta el aviso dentro de la app, así que conviene ser directos. Coach Kal es un modelo de lenguaje. Produce estimaciones y respuestas fluidas que suenan verosímiles, y verosímil no es lo mismo que correcto.",
      ...
      "ai.lim.medB2": "Si estás embarazada, convives con diabetes u otra condición, tomas medicación, te estás recuperando de un trastorno de la conducta alimentaria o vas a cambiar de forma importante tu manera de comer, habla antes con tu médico o con un dietista-nutricionista colegiado. Su criterio va por delante del de Kal: no está pensado para sustituirlos y no debe usarse como si pudiera.",
      ...
      "ai.al.1": "Si has indicado una alergia, Kal no te recomendará un alimento en el que identifique ese ingrediente.",
