...
(function () {
  ...
  var PAGES = {
    ...
    en: {
      ...
      "fx.f6.b": "Complete macros plus micronutrients — vitamins, minerals, fiber, sugar, sodium, NOVA processing level, and glucose & satiety scores.",
      "fx.f6.x1": "Vitamins",
      "fx.f6.x2": "Minerals",
      "fx.f6.x3": "Fiber",
      "fx.f6.x4": "Sugar",
      ...
      "sub.lead": "Fotocal is free to download and free to use every day. Premium removes the daily limit on AI photo scans and switches on the deeper analysis — weekly reports, personalised recommendations, the menu scanner and unlimited voice logging.",
    ...
    es: {
      ...
      "fx.f6.b": "Macros completos y micronutrientes: vitaminas, minerales, fibra, azúcar, sodio, nivel de procesamiento NOVA y puntuaciones de glucosa y saciedad.",
      "fx.f6.x1": "Vitaminas",
      "fx.f6.x2": "Minerales",
      "fx.f6.x3": "Fibra",
      "fx.f6.x4": "Azúcar",
      ...
      "sub.lead": "Fotocal se descarga gratis y se usa gratis todos los días. Premium quita el límite diario de escaneos con IA y enciende el análisis profundo: informes semanales, recomendaciones personalizadas, el escáner de cartas y el registro por voz ilimitado.",
