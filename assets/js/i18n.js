...
window.FOTOCAL_I18N = {
  ...
  en: {
    ...
    "trust.offline": "Works fully offline",
    "trust.langs": "English & Spanish",
    "trust.trial": "3-day free trial · Cancel anytime",
    "trust.health": "Health Connect compatible",
    "price.kicker": "Pricing",
    "price.title": "Simple pricing. Cancel anytime.",
    "price.sub": "Every plan unlocks the same Premium features — the only difference is how long it runs.",
    "price.m.name": "Monthly",
    "price.m.amt": "€6.99",
    "price.m.per": "/month",
    "price.m.note": "The flexible one.",
    "price.q.name": "3 Months",
    "price.q.amt": "€16.99",
    "price.q.per": "every 3 months",
    "price.q.note": "≈ €5.66/month.",
    "price.y.name": "Yearly",
    "price.y.amt": "€34.99",
    "price.y.per": "/year",
    "price.y.badge": "Best value",
    "price.y.equiv": "≈ €2.92/month — save the most.",
    "price.trial": "3-day free trial",
    "price.cancel": "Cancel anytime in Google Play",
    "price.vary": "Prices may vary by country",
  ...
  es: {
    ...
    "trust.gdpr": "Conforme al RGPD",
    "trust.offline": "Funciona sin conexión",
    "trust.langs": "Inglés y español",
    "trust.trial": "3 días de prueba gratis · Cancela cuando quieras",
    "trust.health": "Compatible con Health Connect",
    "price.kicker": "Precios",
    "price.title": "Precios simples. Cancela cuando quieras.",
    "price.sub": "Todos los planes desbloquean las mismas funciones Premium — solo cambia la duración.",
    "price.m.name": "Mensual",
    "price.m.amt": "6,99 €",
    "price.m.per": "/mes",
    "price.m.note": "El flexible.",
    "price.q.name": "3 meses",
    "price.q.amt": "16,99 €",
    "price.q.per": "cada 3 meses",
    "price.q.note": "≈ 5,66 €/mes.",
    "price.y.name": "Anual",
    "price.y.amt": "34,99 €",
    "price.y.per": "/año",
    "price.y.badge": "Mejor valor",
    "price.y.equiv": "≈ 2,92 €/mes — el mayor ahorro.",
    "price.trial": "3 días de prueba gratis",
    "price.cancel": "Cancela cuando quieras en Google Play",
    "price.vary": "Los precios pueden variar según el país",
    "price.cta": "Empieza la prueba gratis",
