...
(function () {
  ...
  /* ── Logo ──
     Rendered at 32 CSS px, so srcset offers the 32/64/96 renders and the
     browser takes the one matching the display. A single large PNG scaled
     down in the browser is both heavier and softer than a file made at the
     size it is shown at.

     The whole set is generated by tools/make_icons.py from one master —
     changing the logo is re-running that script, not editing files here. */
  function logoHTML(href) {
    return '<a class="nav-logo" href="' + href + '" aria-label="Fotocal — home">' +
      '<img class="logo-mark" src="' + asset("assets/img/logo-32.png") + '" ' +
        'srcset="' + asset("assets/img/logo-32.png") + ' 1x, ' +
                    asset("assets/img/logo-64.png") + ' 2x, ' +
                    asset("assets/img/logo-96.png") + ' 3x" ' +
    ...
    return '' +
      '<div class="fc-appbar" id="fcAppbar" hidden>' +
        '<div class="fc-appbar-inner">' +
          /* 40 CSS px here, so 64 is the 1x-ish fit and 96 covers 2x. */
          '<img class="fc-appbar-logo" src="' + asset("assets/img/logo-64.png") + '" ' +
            'srcset="' + asset("assets/img/logo-64.png") + ' 1x, ' +
                        asset("assets/img/logo-96.png") + ' 2x" ' +
